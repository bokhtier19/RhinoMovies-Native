    ...
    if (error || !movie) {
        return (
            <SafeAreaView className="items-center justify-center flex-1 bg-primary">
                ...
                <TouchableOpacity onPress={router.back} className="px-5 py-2 mt-4 rounded-lg bg-accent">
            ...
            <ScrollView contentContainerStyle={{ paddingBottom: 100 }}>
                ...
                <View>
                    ...
                    <TouchableOpacity className="absolute flex items-center justify-center bg-white rounded-full bottom-5 right-5 size-14">
                        <Image source={icons.play} className="w-6 ml-1 h-7" resizeMode="stretch" />
                    </TouchableOpacity>
                </View>
                ...
                <View className="flex-col items-start justify-center px-5 mt-5">
                    ...
                    <View className="flex-row items-center px-2 py-1 mt-2 rounded-md bg-dark-100 gap-x-1">
                        ...
                        <Text className="text-sm font-bold text-white">{Math.round(movie.vote_average)}/10</Text>
                    ...
                    <View className="flex flex-row justify-between w-1/2">
                        <MovieInfo label="Budget" value={`$${Math.round((movie.budget ?? 0) / 1_000_000)}M`} />
